...
class MT5TesterApp(ctk.CTk):
    ...
    def _setup_right_column(self, parent):
        ...
        ctk.CTkButton(ea_buttons_frame, text="↻", width=30, height=24, font=("Arial", 14), command=self._refresh_ea_inputs).pack(side="left")
    ...
    def _refresh_ea_inputs(self):
        ...
        default_inputs = [
            ("InpLotMode", "1", "Lot méretezési mód"),
            ("InpFixedLot", "5", "Fix lot méret"),
            ("prots", "1.0", "Percent"),
    ...
    def _add_date_row(self, parent, label_text, default_value, label_key=None):
        ...
        ctk.CTkButton(frame, text="📅", width=35, command=lambda e=entry: self._open_calendar(e)).pack(side="right")
        return entry, lbl
